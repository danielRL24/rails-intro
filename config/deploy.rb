...
set :repo_url, "git@github.com:danielRL24/rails-intro.git"

# Default branch is :master
set :branch, "the-end"

# Default deploy_to directory is /var/www/my_app_name
set :deploy_to, "/home/daniel/www/rails-intro"
...
# Gérer le redémarrage de Puma et le rechargement de Nginx
namespace :deploy do
	after :finished, :restart_puma do
		on roles(:web) do
			execute :sudo, 'service puma-daniel restart'
